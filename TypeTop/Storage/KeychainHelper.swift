...
///
/// 存儲位置：~/Library/Application Support/TypeTop/apikeys.json
/// 檔案權限：0600（僅本人可讀寫）
enum KeychainHelper {

    private static let directoryName = "TypeTop"
    ...
    private static func loadAll() -> [String: String] {
        ...
        do {
            ...
            print("[TypeTop] API Key 讀取失敗: \(error)")
            return [:]
        }
    }
    ...
    private static func writeAll(_ keys: [String: String]) -> Bool {
        ...
        do {
            ...
            print("[TypeTop] API Key 儲存失敗: \(error)")
            return false
        }
    }
}
